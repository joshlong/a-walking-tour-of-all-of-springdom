package com.joshlong.spring.walkingtour.connectedweb.services;
...
public class UserService implements UserDetailsService {
    ...
    public boolean isUserNameAlreadyTaken(String username) {
        com.joshlong.spring.walkingtour.connectedweb.services.User u = this.loginByUsername(username);
        return u != null;
    }

    public com.joshlong.spring.walkingtour.connectedweb.services.User createOrGet(String user, String pw, String fn, String ln, boolean importedFromServiceProvider) {
        com.joshlong.spring.walkingtour.connectedweb.services.User usr;
    ...
    public com.joshlong.spring.walkingtour.connectedweb.services.User login(String username, String password) {
    ...
    public com.joshlong.spring.walkingtour.connectedweb.services.User createUser(String username, String pw, String fn, String ln, boolean imported) {
        ...
        com.joshlong.spring.walkingtour.connectedweb.services.User user = new com.joshlong.spring.walkingtour.connectedweb.services.User();
   ...
   public Authentication establishSpringSecurityLogin(String localUserId) {
    ...
    public com.joshlong.spring.walkingtour.connectedweb.services.User loginByUsername(String user) {
        Collection<com.joshlong.spring.walkingtour.connectedweb.services.User> customers = entityManager.createQuery("select u from " + com.joshlong.spring.walkingtour.connectedweb.services.User.class.getName() + " u where u.username = :username", com.joshlong.spring.walkingtour.connectedweb.services.User.class).setParameter("username", user).getResultList();
        return firstOrNull(customers);
    }

    public com.joshlong.spring.walkingtour.connectedweb.services.User loginByUsernameAndPassword(String user, String pw) {
        Collection<com.joshlong.spring.walkingtour.connectedweb.services.User> customers = entityManager.createQuery("select u from " + com.joshlong.spring.walkingtour.connectedweb.services.User.class.getName() + " u where u.username = :u and u.password = :p", com.joshlong.spring.walkingtour.connectedweb.services.User.class).setParameter("u", user).setParameter("p", pw).getResultList();
        return firstOrNull(customers);
    }

    @PreAuthorize(USER_ID_IS_PRINCIPAL_ID)
    public void writeUserProfilePhoto(long userId, String ogFileName, InputStream inputStream) throws Throwable {
        final com.joshlong.spring.walkingtour.connectedweb.services.User usr = getUserById(userId);
    ...
    @PreAuthorize(USER_ID_IS_PRINCIPAL_ID)
    public com.joshlong.spring.walkingtour.connectedweb.services.User getUserById(long userId) {
        return this.entityManager.find(com.joshlong.spring.walkingtour.connectedweb.services.User.class, userId);
    }
